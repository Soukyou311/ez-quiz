  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[300px] bg-violet-500/5 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            <span className="text-2xl font-bold text-orange-400 font-['Crimson_Pro',serif]">Q</span>
          </motion.div>
          <h1 className="text-3xl font-bold text-white mb-2 font-['Crimson_Pro',serif]">EZ Quiz</h1>
          <p className="text-zinc-400 font-['DM_Sans',sans-serif]">AWS 认证刷题平台</p>
        </div>

        {/* Form Card */}
        <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-900/60 border border-zinc-800/80 rounded-2xl p-8 backdrop-blur-sm">
          {/* Tabs */}
            ...
            {isRegister && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-zinc-800/50 border border-zinc-700/50 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500/50 transition-colors"
                />
              </div>
            )}
